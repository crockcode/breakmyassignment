...
export default function Footer() {
  return (
    <footer className="w-full py-8 bg-[#111318] border-t border-gray-800 relative z-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 flex flex-col md:flex-row justify-between items-center">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-8 text-sm">
          ...
          <div className="flex flex-col items-center md:items-start">
            <h3 className="font-semibold text-gray-300 mb-3">Resources</h3>
            <ul className="space-y-2">
              <li><Link href="/docs" className="text-gray-400 hover:text-blue-400 transition">Documentation</Link></li>
          ...
          <div className="flex flex-col items-center md:items-start col-span-2 md:col-span-1">
            <h3 className="font-semibold text-gray-300 mb-3">Connect</h3>
      ...
      <div className="max-w-7xl mx-auto px-4 mt-8 pt-6 border-t border-gray-800 text-center text-gray-500 text-xs">
        <p>© {new Date().getFullYear()} BreakMyAssignment. All rights reserved.</p>
      </div>
    </footer>
  );
} 